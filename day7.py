...
signal_permutations: List[Tuple[int, ...]] = list(itertools.permutations(range(0, 5), 5))
...
feedback_permutations: List[Tuple[int, ...]] = list(itertools.permutations(range(5, 10), 5))
